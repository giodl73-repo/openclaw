...
Generated entries: 61.

| Command          | Description                                                                                                         | Effect                                    | Source   |
| ---------------- | ------------------------------------------------------------------------------------------------------------------- | ----------------------------------------- | -------- |
| `crestodian`     | Open the ring-zero setup and repair helper                                                                          | Unknown                                   | `core`   |
| `setup`          | Alias for openclaw onboard                                                                                          | Unknown                                   | `core`   |
...
| `backup`         | Create and verify local backup archives for OpenClaw state                                                          | Unknown                                   | `core`   |
...
| `audit`          | Inspect metadata-only agent run and tool action records                                                             | Unknown                                   | `core`   |
...
| `approvals`      | Manage exec approvals (gateway or node host)                                                                        | Unknown                                   | `subcli` |
