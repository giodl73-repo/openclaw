...
| `pnpm test:docker:hosting-profiles`                                         | Package-installed Gateway proof for built-in hosting-profile selection and `/readyz` condition aggregation. The base lane proves the default `local` profile, required versus advisory conditions, and stable failure/advisory arrays.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
