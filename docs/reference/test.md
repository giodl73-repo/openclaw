...
| `pnpm test:docker:hosting-profiles`                                         | Package-installed Gateway proof for built-in hosting-profile selection and `/readyz` condition aggregation. The lane proves default `local` readiness, a LAN-bound `container` profile becoming ready, a loopback-bound `container` profile returning `503` with `ContainerGatewayLoopback`, required versus advisory conditions, and stable failure/advisory arrays.                                                                                                                                                                                                                                                                                                                         |
