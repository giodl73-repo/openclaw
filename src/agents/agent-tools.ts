...
import type { ExplicitSkillInvocation, SkillSnapshot, SkillUsagePath } from "../skills/types.js";
...
type OpenClawCodingToolsOptions = {
  ...
  runId?: string;
  /** Trusted identity for the explicit skill running in this agent invocation. */
