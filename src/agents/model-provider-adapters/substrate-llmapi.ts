...
export const SUBSTRATE_LLMAPI_MODEL_ADAPTER_ID = "substrate/llmapi" as const;
export const SUBSTRATE_BEARER_SLOT_ID = "substrate/token" as const;
...
function resolveModelType(
  ...
  if (sourceModel) {
    const mapped = Object.hasOwn(config.modelMap, sourceModel)
      ? config.modelMap[sourceModel]
      : undefined;
