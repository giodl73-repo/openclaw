...
export function createOpenClawTools(
  options?: {
    ...
    runId?: string;
    /** Skills available to this run for validated child skill invocation. */
    skillsSnapshot?: SkillSnapshot;
    /** Trusted invocation identity for the currently running skill. */
    ...
    ...(includeSubagentSpawnTool
      ? [
          createSessionsSpawnTool({
            ...
            parentSkillInvocation: options?.explicitSkillInvocation,
