...
export const CLI_ZH_CN_CATALOG = {
  ...
  "cli.logs.positiveInteger": "{flag} 必须是正整数。",
  "cli.logs.outputClosed": "openclaw logs：输出 {target} 已关闭（{code}）。正在停止日志跟踪。",
  "cli.logs.gatewayUnreachable": "无法访问网关。网关是否正在运行并且可以访问？",
  "cli.logs.doctorHint": "提示：运行 `{command}`。",
  "cli.logs.localFallback": "本地网关 RPC 不可用；改为读取已配置的文件日志。",
  "cli.logs.journalFallback": "本地网关 RPC 不可用；改为读取活动的 systemd 网关日志。",
  "cli.logs.gatewayDisconnected": "[logs] 网关已断开；将在 {seconds} 秒后重新连接...",
  "cli.logs.gatewayReconnected": "[logs] 网关已重新连接",
  "cli.logs.source": "日志来源：",
  "cli.logs.servicePid": "服务 PID：",
  "cli.logs.serviceUnit": "服务单元：",
  "cli.logs.file": "日志文件：",
  "cli.logs.truncated": "日志尾部已截断（请增大 --max-bytes）。",
  "cli.logs.cursorReset": "日志游标已重置（文件已轮转）。",
