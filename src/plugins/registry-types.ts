...
import type { ContinuityPublicationProviderRegistration } from "../continuity/publication-provider.js";
...
export type PluginRegistry = {
  ...
  continuityPublicationProviders: ContinuityPublicationProviderRegistration[];
