...
const noopRegisterSettingsConstraintsProvider: OpenClawPluginApi["registerSettingsConstraintsProvider"] =
  () => {};
...
export function buildPluginApi(params: BuildPluginApiParams): OpenClawPluginApi {
  ...
  const api: OpenClawPluginApiWithoutFacades = {
    ...
    registerSettingsConstraintsProvider:
      handlers.registerSettingsConstraintsProvider ?? noopRegisterSettingsConstraintsProvider,
