...
const TOOL = "lobster:rust-gateway-stream-input";
...
function resolveCargo() {
  ...
  throw new Error("Cargo is required for the Rust Gateway stream-input proof");
}
...
const result = spawnSync(
  ...
  [
    ...
    "src/gateway/rust-gateway-stream-input.e2e.test.ts",
  ],
  {
    env: {
      ...process.env,
