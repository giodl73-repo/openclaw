...
const TOOL = "lobster:rust-gateway-reconnect-continuity";
...
function resolveCargo() {
  ...
  throw new Error("Cargo is required for the Rust Gateway reconnect proof");
}
...
const result = spawnSync(
  ...
  [
    ...
    "src/gateway/rust-gateway-reconnect-continuity.e2e.test.ts",
  ],
  {
