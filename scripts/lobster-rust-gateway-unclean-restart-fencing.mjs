...
const TOOL = "lobster:rust-gateway-unclean-restart-fencing";
...
function resolveCargo() {
  ...
  throw new Error("Cargo is required for the Rust Gateway unclean-restart proof");
}
...
const result = spawnSync(
  ...
  [
    ...
    "src/gateway/rust-gateway-unclean-restart-fencing.e2e.test.ts",
  ],
  {
