...
export const KNIP_UNUSED_EXPORT_BASELINE = [
  ...
  "extensions/lobster/src/lobster-tool.ts: createEmbeddedOpenClawInvoke",
  "extensions/lobster/src/lobster-tool.ts: createEmbeddedOpenClawWaitForRun",
  ...
  "src/plugins/runtime/types.ts: SubagentRunAudit",
  ...
  "src/skills/invocation.ts: CreateExplicitSkillInvocationParams",
  ...
  "src/trajectory/skill-invocation.ts: recordSkillInvocationCompleted",
