...
const TOOL = "lobster:rust-gateway-deadline-cancellation";
...
function resolveCargo() {
  ...
  throw new Error("Cargo is required for the Rust Gateway deadline-cancellation proof");
}
...
const result = spawnSync(
  ...
  [
    ...
    "src/gateway/rust-gateway-deadline-cancellation.e2e.test.ts",
  ],
  {
