...
async function graphRequest(params: {
  ...
  // D5c defines the inactive hosted binding consumed by D5d. Until that
  // selection is activated, preserve the existing brokered egress path while
  // applying the owner-prepared request and OpenClaw's network guard.
