...
const M365MAIL_SETUP_HELP_LINES = [
  "Microsoft 365 email runs brokered inside the Lobster container:",
  "1) Lobster provisions the agent identity and projects M365MAIL_* env vars",
...
const M365MAIL_ALLOW_FROM_HELP_LINES = [
  "Allowlist Microsoft 365 email senders by address (or AAD object id).",
  "Examples:",
  "- ada@contoso.com",
...
function isM365MailConfigured(cfg: OpenClawConfig, accountId: string): boolean {
  ...
  return resolveAccount(cfg, accountId).enabled;
}
...
export const m365MailSetupWizard: ChannelSetupWizard = {
  ...
  allowFrom: createAllowFromSection({
    ...
    invalidWithoutCredentialNote: "Senders must be email addresses or AAD object ids.",
